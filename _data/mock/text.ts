...
export const description = [
  ...
  'This job took 3 months to complete and roughly 200 working hours, it was completed by a team of 4 highly talented tradesmen based in Wolverhampton, if you would like the builders contact details feel free to request them on our contact us page.',
...
export const review = [
  'I recently had my roof replaced by this company, and I could not be happier with the results! They were prompt, courteous, and professional throughout the entire process. The new roof looks fantastic, and the crew really went above and beyond to make sure every detail was perfect. Highly recommend this roofing company!',
  'I had the pleasure of working with this roofing company and I was extremely impressed with the quality of their work. They were very professional, completed the job on time, and were very affordable. I highly recommend them for any roofing needs!',
  "These people are great, I honestly can't say anything bad about them. Very reasonable pricing for excellent work. They were cordial, on time, and informed me at all times. I'll most certainly use them again.",
  'Very good work completed, polite staff, excellent value it is impossible to find a better company. I am extremely delighted with the work completed and would use them again when I have the opportunity.',
  'I called this company for house for my roof repair and they did such a fast time. prices were much more affordable and the quality of their work was good!',
  'K P Young Roofing Ltd went above and beyond! We had our roof replaced. His team were fast (finished on time), very clean they cleaned up all the site before leaving. Great quality work for very fair price! I highly recommend them.',
  "Kev & team were great, he fit us in really quickly, he was friendly & helpful & we’re pleased with the work carried out. Would happily contact again.",
  "Very well finished my project. My garage roof looking the best."
];
